        ...
        exports.default = function(pathname, routesMap, serializer) {
          ...
          if (match) {
            ...
            var payload = keys.reduce(function(payload, key, index) {
              ...
              value =
                capitalizedWords && typeof value === 'string'
...
*/
        ...
        exports.default = function(history) {
          ...
          var _options$notFoundPath = options.notFoundPath,
            ...
            scrollTop =
              _options$scrollTop === undefined ? false : _options$scrollTop,
          ...
          var INITIAL_LOCATION_STATE = (
            0,
            _createLocationReducer.getInitialState
          )(currentPath, meta, type, payload, routesMap, history)
   ...
   */
          ...
          var _historyAttemptDispatchAction = function _historyAttemptDispatchAction(
            ...
            if (nextPath !== currentPath) {
              ...
              var kind =
                historyAction === 'REPLACE' ? 'redirect' : historyAction
